...
void menu(){
    cout<<"1-Append text to the file   2-Display the content of the file   3-Empty the content of the file   4-Encrypt the file content \n";
    cout<<"5-Decrypt the file content  6-Merge with another file           7-Count the words number in file  8-Count the number of characters \n";
    cout<<"9-Count the lines in file   10-search for a word                11-Count the number of times a word exists in the file  12-Turn to uppercase\n";
    cout<<"13-Turn the file content to lower case   14-Turn file content to 1st caps   15-save   16-Exit \n\n";
}
